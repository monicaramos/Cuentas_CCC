...
'                    .Text = ""
        ...
        Select Case tipoF 'Comprobar longitud
            ...
            Case 3 'Decimal(10,2)
                ...
                End If
            Case 4 'Decimal(7,2)
                If Len(CStr(PEntera)) > 5 Or ((Len(CStr(PEntera)) = 5) And (Valor > 10000)) Then
                    MsgBox "El valor no puede ser mayor de 10000,00", vbExclamation
                    NoOK = True
                End If
            Case 5 'Decimal(10,3)
